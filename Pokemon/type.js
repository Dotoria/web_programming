...
var TYPE_INFO = {
    normal:   { name: '노말',   color: '#A8A878', icon: '⚪', pokemon: '이브이 · 잠만보 · 캥카',
                surface: '무난함, 평범함',
    ...
    fire:     { name: '불꽃',   color: '#F08030', icon: '🔥', pokemon: '리자몽 · 블레이범 · 마그마번',
                surface: '열정, 다혈질',
    ...
    water:    { name: '물',     color: '#6890F0', icon: '💧', pokemon: '갸라도스 · 거북왕 · 라프라스',
                surface: '유연함, 온화함',
    ...
    grass:    { name: '풀',     color: '#78C850', icon: '🌿', pokemon: '이상해꽃 · 리피아 · 나시',
                surface: '평화, 느긋함',
    ...
    electric: { name: '전기',   color: '#F8D030', icon: '⚡', pokemon: '피카츄 · 썬더 · 자포코일',
                surface: '발랄, 즉흥',
    ...
    poison:   { name: '독',     color: '#A040A0', icon: '☠️', pokemon: '니드킹 · 질뻐기 · 크로뱃',
                surface: '경계심, 뒤끝',
    ...
    ground:   { name: '땅',     color: '#E0C068', icon: '⛰️', pokemon: '텅구리 · 닥트리오 · 코뿌리',
                surface: '현실적, 안정',
    ...
    flying:   { name: '비행',   color: '#A890F0', icon: '🕊️', pokemon: '토네로스 · 음번 · 아머까오',
                surface: '자유로움',
    ...
    rock:     { name: '바위',   color: '#B8A038', icon: '🪨', pokemon: '레지락 · 딱구리 · 마기라스',
                surface: '안 변함',
    ...
    ghost:    { name: '고스트', color: '#705898', icon: '👻', pokemon: '팬텀 · 기라티나 · 샹델라',
                surface: '은둔, 장난기',
    ...
    dragon:   { name: '드래곤', color: '#7038F8', icon: '🐉', pokemon: '망나뇽 · 한카리아스 · 레쿠쟈',
                surface: '강함, 자부심',
    ...
    dark:     { name: '악',     color: '#705848', icon: '🌑', pokemon: '블래키 · 조로아크 · 절각참',
                surface: '무심함, 자기기준',
    ...
    steel:    { name: '강철',   color: '#B8B8D0', icon: '⚙️', pokemon: '메타그로스 · 보스로라 · 코바르온',
                surface: '단단함, 원칙',
    ...
    fairy:    { name: '페어리', color: '#EE99AC', icon: '💖', pokemon: '픽시 · 님피아 · 토게키스',
                surface: '사랑스러움',
